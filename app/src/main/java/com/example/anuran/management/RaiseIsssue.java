...
public class RaiseIsssue extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button_selectpic:
                ...
                startActivityForResult(Intent.createChooser(intent, "Choose application"), Constants.REQCODE);
                break;
            case R.id.uploadButton:
                ...
                try {
                    jsonObject.put(Constants.imageName, etxtUpload.getText().toString().trim());
                    jsonObject.put(Constants.imageList, jsonArray);
                } catch (JSONException e) {
                    Log.e("JSONObject Here", e.toString());
                }
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.URL_IMAGE, jsonObject,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (requestCode == Constants.REQCODE && resultCode == RESULT_OK
                    && null != data) {
