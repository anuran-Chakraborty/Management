...
public class Confirm extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(Confirm.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDate,year,month,day);
   ...
   @Override
    ...
    private void confirmme() {
        ...
        progressDialog = new ProgressDialog(Confirm.this);
