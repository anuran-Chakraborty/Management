...
public class HeadLogin extends AppCompatActivity {
    ...
    private void userLogin(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.URL_LOGIN_HEADLOGIN, new Response.Listener<String>() {
            @Override
